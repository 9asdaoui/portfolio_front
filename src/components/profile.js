...
const Profile = () => {
        ...
        return (
            <section id="profile" className="py-20 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <p className="text-center text-lg text-gray-600">Loading profile information...</p>
                </div>
            </section>
        );
    }
    ...
    return (
        <section id="Profile" className="py-40 bg-gradient-to-b from-white to-gray-100 p-20">
                    ...
                    <div className="lg:col-span-4 text-center lg:text-left">
                        <div className="mb-8 relative mx-auto lg:mx-0 w-48 h-48">
                            {profile.profile_image ? (
                                ...
                                <div className="rounded-full w-full h-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center border-4 border-white shadow-lg">
                        ...
                        <div className="flex justify-center lg:justify-start space-x-5 mt-6 mb-8">
                            <a href="https://github.com/9asdaoui" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-indigo-600 transition-colors">
                            ...
                            <a href="https://www.linkedin.com/in/oussama-qasdaoui-692164287/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-indigo-600 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
                                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                </svg>
                            </a>
                            <a href={`mailto:${profile.email}`} className="text-gray-700 hover:text-indigo-600 transition-colors">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                                ...
                                <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100">
                                    <h3 className="font-semibold text-gray-800 mb-3">Tools & Frameworks</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {Array.isArray(userTools) && userTools.length > 0 ? (
                                            ...
                                            <span className="text-gray-500">No tools specified yet</span>
                                        )}
                                    </div>
                                </div>
                        </div>
