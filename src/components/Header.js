                            ...
                            <header className="bg-white shadow-md fixed w-full z-10">
                                          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                                        <div className="flex justify-between h-16">
                                                                      <div className="flex items-center">
                                                                                    <a href="#Profile" onClick={(e) => { e.preventDefault(); scrollToSection('Profile'); }} className="flex-shrink-0 flex items-center">
                                                                      ...
                                                                      <nav className="hidden md:flex space-x-10 items-center">
                                                                                    <a href="#Profile" onClick={(e) => { e.preventDefault(); scrollToSection('Profile'); }} className="text-gray-700 hover:text-indigo-600 transition duration-300">Profile</a>
                                          ...
                                          <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
                                                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
                                                                      <a href="#Profile" onClick={(e) => { e.preventDefault(); scrollToSection('Profile'); }} className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-100">Profile</a>
